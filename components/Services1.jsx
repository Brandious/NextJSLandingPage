...
const Feature = () => {
    const features = [
        { id: 1, img: "/static/slike-vedras/service1.jpg", title: "Želite vašim klijentima i zaposlenicima pružiti potpuno čist prostor? Kontaktirajte nas odmah, neka vaš prostor bude #covidfree!", desc: "", link: "" },
        {
            id: 2, img: "/static/slike-vedras/service2.jpg", title: "Naše tehničko osoblje spremno je u najkraćem mogućem roku izvršiti uslugu koja uključuje:", desc: ["dopremu UV-dezinfekcijskog robota",
